...
class SE3Norm(nn.Module):
    ...
    def forward(self, pos, node_mask):
        ...
        new_pos = self.weight * pos / (mean_norm + self.eps)  # Fixed value of eps ensures that the norm is same for all batches
        return new_pos

    def extra_repr(self) -> str:
        return '{normalized_shape}, eps={eps}'.format(**self.__dict__)

# Converts nodal features to global features
...
# Converts edge features to global features
